...
export const COMPONENT_CATEGORIES: ComponentCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "color-picker", label: "ColorPicker", keywords: ["colorpicker", "palette"] },
      {
        id: "inpost-geowidget",
    ...
    items: [
      {
        id: "navigation",
        label: "Navigation",
        keywords: ["tabs", "breadcrumb", "pagination", "bottomnavigation", "stepper"],
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "layouts",
        label: "Layouts",
        keywords: ["dashboardshell", "detailpagelayout", "settingslayout", "appshell"],
      },
    ],
  },
];
