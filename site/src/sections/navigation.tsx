  ...
  return (
    <div className="mt-8 border-t border-border/60 pt-6">
      ...
      <p className="text-xs text-muted-foreground mb-4">
        An interactive multi-step progress indicator and form wizard supporting step completion,
        active indicators, titles, descriptions, and content panels using <code>useStepper</code>.
      </p>
      <Box className="mb-0">
          ...
          <div className="mt-6 p-5 border border-border rounded-kj-lg bg-surface min-h-[120px] flex flex-col justify-between">
            <StepperContent value={0}>
              <div className="space-y-2">
                <h3 className="text-sm font-semibold m-0">Step 1: Account Setup</h3>
                <p className="text-xs text-muted-foreground">
                  Enter your contact email and password to create an account.
                </p>
                <div className="pt-2 max-w-xs">
                  <Input aria-label="Email address" placeholder="email@company.com" />
                </div>
              </div>
            </StepperContent>
            ...
            <StepperContent value={1}>
              <div className="space-y-2">
                <h3 className="text-sm font-semibold m-0">Step 2: Shipping Address</h3>
                <p className="text-xs text-muted-foreground">
                  Specify the physical delivery location for your package.
                </p>
                <div className="pt-2 max-w-xs">
                  <Input aria-label="Shipping address" placeholder="123 Main St, City, Country" />
                </div>
              </div>
            </StepperContent>
            ...
            <StepperContent value={2}>
              <div className="space-y-2">
                <h3 className="text-sm font-semibold m-0">Step 3: Payment Details</h3>
                <p className="text-xs text-muted-foreground">
                  Review your checkout total and enter payment details.
                </p>
                <div className="pt-2 max-w-xs">
                  <Input aria-label="Card number" placeholder="Card number: •••• •••• •••• 4242" />
                </div>
              </div>
            </StepperContent>
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 border-t border-border/60 pt-6">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          A responsive bottom navigation bar designed for mobile apps, featuring active styling
          indicators, badge notifications, and glassmorphic styling.
        </p>
        <div className="max-w-[360px] mx-auto border border-border rounded-kj-xl overflow-hidden bg-canvas relative h-[140px] flex flex-col justify-end shadow-kj-sm">
          <div className="flex-1 p-4 flex flex-col justify-center items-center text-center">
            ...
            <span className="text-xs font-semibold text-foreground mt-1.5">
              Active tab: {bottomNavActive.toUpperCase()}
            </span>
          </div>
          <BottomNavigation
            fixed={false}
            ...
            items={[
              ...
              },
              {
                ...
                label: "Alerts",
                icon: IcoSun,
                active: bottomNavActive === "alerts",
                badge: "3",
                onClick: () => setBottomNavActive("alerts"),
              },
              {
                id: "settings",
                label: "Settings",
                icon: IcoGear,
                active: bottomNavActive === "settings",
      ...
      <div className="mt-8 border-t border-border/60 pt-6">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          A fast, accessible command palette for keyboard-first navigation and quick actions. Press{" "}
          <Kbd keys={["⌘", "K"]} /> or click below to launch.
        </p>
        <Box className="mb-0">
          <Button
            variant="outline"
