...
### Fixed
- Layout token responsiveness alignment and mobile padding utilities.

## [0.9.0] - 2026-07-21

### Added
- ProgressRing SVG strokeDashoffset and size metrics.
- ImageGallery thumbnail grid aspect-ratio token utilities.
