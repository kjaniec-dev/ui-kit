      ...
      <AppShell.Main width="narrow">
        <div className="py-8 space-y-4">
          ...
          <p className="text-muted-foreground">
            This story demonstrates using the compound subcomponents pattern with narrow content
            width constraint.
          </p>
        </div>
      </AppShell.Main>
      <AppShell.Footer>
        <div className="text-center text-sm text-muted-foreground">Built with AppShell.Footer</div>
      </AppShell.Footer>
    </AppShell>
  ),
};
